...
let bannerModal = document.querySelector('.page__modal');
let bannerOpen = document.querySelector('.banner__button');
let bannerClose = document.querySelector('.modal__close');



bannerOpen.onclick = function() {

  bannerModal.classList.add('modal--open');
...
bannerClose.onclick = function() {
  ...
  bannerModal.classList.remove('modal--open');
...
window.addEventListener("keydown", function(event) {
  ...
  if (event.keyCode == 27) {
    ...
    if (bannerModal.classList.contains("modal--open")) {
